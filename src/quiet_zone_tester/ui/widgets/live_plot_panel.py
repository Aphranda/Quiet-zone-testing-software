...
class LivePlotPanel(QGroupBox):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self._dut_vna_button = QPushButton("网分直通")
        ...
        self._dut_vna_amp1_button = QPushButton("网分经AMP1")
        self._dut_vna_amp1_button.setObjectName("dutPathButton")
        self._dut_vna_amp1_button.setCheckable(True)
        ...
        self._dut_path_buttons.addButton(self._dut_vna_amp1_button)
        ...
        self._dut_vna_amp1_button.clicked.connect(lambda _checked=False: self.dut_path_requested.emit("VNA2_AMP1"))
        ...
        header.addWidget(self._dut_vna_amp1_button)
